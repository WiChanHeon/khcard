					...
					<div class="slider-banner-container">
						<div class="slider-banner-fullwidth-big-height">
							<ul class="slides">
								...
								<!-- main image -->
								<img src="${pageContext.request.contextPath}/resources/user/images/shop-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
								...
								<!-- main image -->
								<img src="${pageContext.request.contextPath}/resources/user/images/shop-slide-2.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
								...
								<div class="tab-pane active" id="pill-1">
									<div class="row masonry-grid-fitrows grid-space-10">
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-1.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-2.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-3.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-4.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-5.jpg" alt="">
													<span class="badge">30% OFF</span>
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-6.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-7.jpg" alt="">
										...
										<div class="col-md-3 col-sm-6 masonry-grid-item">
											<div class="listing-item white-bg bordered mb-20">
												<div class="overlay-container">
													<img src="${pageContext.request.contextPath}/resources/user/images/product-8.jpg" alt="">
							...
							<div class="clients-container">
								<div class="clients">
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-1.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-2.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="300">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-3.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="400">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-4.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="500">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-5.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="600">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-6.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="700">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-7.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="800">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-8.png" alt=""></a>
									</div>
									<div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/client-1.png" alt=""></a>
									</div>
				...
				<div class="owl-carousel carousel-autoplay pl-10 pr-10">
					<div class="listing-item pl-10 pr-10 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-1.jpg" alt="">
					...
					<div class="listing-item pl-10 pr-10 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-2.jpg" alt="">
							<a class="overlay-link" href="#"><i class="fa fa-plus"></i></a>
							<div class="overlay-bottom">
								<div class="text">
									<h3 class="title">Category Title</h3>
					...
					<div class="listing-item pl-10 pr-10 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-3.jpg" alt="">
							<a class="overlay-link" href="#"><i class="fa fa-plus"></i></a>
							<div class="overlay-bottom">
								<div class="text">
									<h3 class="title">Category Title</h3>
					...
					<div class="listing-item pl-10 pr-10 mb-20 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-4.jpg" alt="">
							<a class="overlay-link" href="#"><i class="fa fa-plus"></i></a>
							<div class="overlay-bottom">
								<div class="text">
									<h3 class="title">Category Title</h3>
					...
					<div class="listing-item pl-10 pr-10 mb-20 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-5.jpg" alt="">
							<a class="overlay-link" href="#"><i class="fa fa-plus"></i></a>
							<div class="overlay-bottom">
								<div class="text">
									<h3 class="title">Category Title</h3>
					...
					<div class="listing-item pl-10 pr-10 mb-20 mb-20">
						<div class="overlay-container bordered overlay-visible">
							<img src="${pageContext.request.contextPath}/resources/user/images/category-6.jpg" alt="">
							<a class="overlay-link" href="#"><i class="fa fa-plus"></i></a>
							<div class="overlay-bottom">
								<div class="text">
									<h3 class="title">Category Title</h3>
