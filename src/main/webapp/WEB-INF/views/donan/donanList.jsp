...
<div id="w_div">	
   ...
   <div class="sangdan1">
	...
	<div class="check_zone" > 
		<p class="eyong">이용전 반드시 확인하세요 <span class="caret"></span></p>
		
		<div class="nae" style="display :none;">
			<ul class="listDot"> 
				<li>분실신고를 하시기전 먼저 카드 승인내역을 확인하시기 바랍니다.&nbsp;
					<a href="#" class="btn_renewalType type4">
						<span class="inner">국내이용내역</span>
					</a>&nbsp;
					<a href="#" class="btn_renewalType type4">
						<span class="inner">해외이용내역</span>
					</a>
				</li>
