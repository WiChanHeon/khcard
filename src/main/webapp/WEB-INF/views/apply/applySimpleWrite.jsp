...
<form:form action="applysimplewrite.do" commandName="applySimple" id="Bapply_register" onsubmit="return Simplepopup(this)" >
	...
	<li>카드신청이 어려우시다면 간편하게 성명,휴대전화번호를 남겨주세요.
		KH카드 전문 상담원이 상담해드립니다.</li>
	<li><hr size="2"></li>	
	</ul>
 	...
 	<ul class="Bapply_list">
       ...
       <label for="sap_cell">휴대전화</label>  
          ...
          placeholder="- 없이 입력"/>
          <form:errors path="sap_cell" class="error-color"/><hr><br>
        </li>
        <li class="align-center">
          <input type="submit" value="상담신청" class="Bapplybutton"><br><br><br>
        </li>
    </ul>
