 ...
 <br><br>
   ...
   <table class="Btable">
      ...
      <tr class='even'>
         ...
         <td class="Balign-left">
            <c:if test="${apply2.ap_pass == 0 }">
            고객님께서 신청하신 카드가 정상적으로 심사 접수 되었고, 현재 발급 진행중입니다.
            </c:if>
            <c:if test="${apply2.ap_pass == 1 }">
            축하드립니다. 고객님께서 신청하신 카드가 정상적으로 심사 승인되어 영업일 10일 안으로 발송됩니다.
            </c:if>
            <c:if test="${apply2.ap_pass == 2 }">
            죄송합니다. 고객님께서 신청하신 카드가 정상적으로 접수되었으나 심사 보류중에 있어 몇 가지 확인차 연락 후 진행됩니다.
            </c:if>
            <c:if test="${apply2.ap_pass == 3 }">
            고객님께서는 저희 KH카드 심사조건에 맞지 않아 카드발급이 거절되었습니다.
            </c:if>
